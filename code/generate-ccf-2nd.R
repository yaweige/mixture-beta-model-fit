...
ccf_km_full <- land_score_km_generator2("./data/comp/")
ccf_knm_full <- land_score_knm_generator2("./data/comp/")
#
saveRDS(ccf_km_full, file = "./data/ccf/ccf_km_2nd.rds")
saveRDS(ccf_knm_full, file = "./data/ccf/ccf_knm_2nd.rds")
