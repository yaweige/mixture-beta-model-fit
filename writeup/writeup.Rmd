...
\hh{$\mu$ is the location parameter of the distribution, $\phi$ is called the precision or dispersion parameter }\citep{Ferrari2004}.
\end{definition}
