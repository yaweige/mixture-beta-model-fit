...
Reproduce Table 1 (now 3) with `kableExtra`
...
xtable(table1_data, caption = "aaaaaaaaaaa") %>%
  xtable2kable() %>%
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign = "middle")

xtable1 <- xtable(table1_data, caption = "aaaaaaaaaaa")
