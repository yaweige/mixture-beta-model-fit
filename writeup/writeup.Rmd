...
```{r data-input-section, include=FALSE,eval=FALSE}
...
```{r model-estimation-section, include=FALSE,eval=FALSE}
...
param_extract <- function(model) {
  ...
  if(nparam == 2) {
    ...
    output <- data.frame(p1 = par[1],
                         ...
                         a2 = par[4],
                         b2 = par[5])
    output <- output %>% mutate(mu1 = 1/(a1+b1),
                                phi1 = a1+b1,
                                mu2 = 1/(a2+b2),
                                phi2 = a2+b2)
  } else if (nparam == 8) {
...
# These are randomly generated sequences, to reduce the randomness of each run, it is stored
change_size_sequences <- read_csv("../data/organized data/ccf-related/change_size_sequences.csv")
...
# KM, start 1, sequence 1, first 100
km_st1_sq1_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq1[1:100], start = starting_1[1,], class = "km")
# .............sequence 2
km_st1_sq2_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq2[1:100], start = starting_1[1,], class = "km")
# .............sequence 3
km_st1_sq3_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq3[1:100], start = starting_1[1,], class = "km")
# ....start 2..seq 1
km_st2_sq1_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq1[1:100], start = starting_2[1,], class = "km")
# ....start 2..seq 2
km_st2_sq2_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq2[1:100], start = starting_2[1,], class = "km")
# ....start 2..seq 3
km_st2_sq3_100 <- change_size_sequence_fit(ccf_km_full_data, seq = change_size_sequences$seq3[1:100], start = starting_2[1,], class = "km")


# KNM, start 1, sequence 1, first 100
knm_st1_sq1_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq1[1:100], start = starting_1[2,], class = "knm")
# .............sequence 2
knm_st1_sq2_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq2[1:100], start = starting_1[2,], class = "knm")
# .............sequence 3
knm_st1_sq3_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq3[1:100], start = starting_1[2,], class = "knm")
# ....start 2..seq 1
knm_st2_sq1_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq1[1:100], start = starting_2[2,], class = "knm")
# ....start 2..seq 2
knm_st2_sq2_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq2[1:100], start = starting_2[2,], class = "knm")
# ....start 2..seq 3
knm_st2_sq3_100 <- change_size_sequence_fit(ccf_knm_full_data, seq = change_size_sequences$seq3[1:100], start = starting_2[2,], class = "knm")

change_size_sequence_result <- list(km_st1_sq1_100,
                                    km_st1_sq2_100,
                                    km_st1_sq3_100,
                                    km_st2_sq1_100,
                                    km_st2_sq2_100,
...
\begin{align*}
f(y;p, \mu, \phi) =& p_{1}f_1(y;\mu_{1}, \phi_{1}) + p_{2}f_2(y;\mu_{2}, \phi_{2}) +...+ p_{k}f_k(y;\mu_{k}, \phi_{k}),
\end{align*}
where
$f_\ell(\cdot;\mu_{\ell}, \phi_{\ell})$, $\ell = 1, 2, 3, ..., k$ are beta densities
and parameters
$p$, $\mu$ and $\phi$ are  defined as:
\begin{align*}
