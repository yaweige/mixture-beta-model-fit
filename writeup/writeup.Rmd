...
\hh{XXX it's generally better to avoid describing anything as 'our' - that creates distance to the reader.}
\hh{Note, that we assume different beta mixture distributions ...}
