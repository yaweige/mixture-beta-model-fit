...
given a questioned bullet and a suspected firearm, 
\hh{XXX We need to be a bit cautious about how we phrase this. Sometimes there is no suspected firearm. If we want to make this assumption, we are excluding a lot of comparisons}
