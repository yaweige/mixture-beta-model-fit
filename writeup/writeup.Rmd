...
For either of the two scenarios, we will assume that a suspected firearm is available. \hh{In case a firearm is not available, deriving reliable scores and associated densities becomes more complicated. We touch on this scenario and its limitations in the discussion.} 
Scores are derived by comparing test fires and the questioned bullet. 
